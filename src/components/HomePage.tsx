        ...
        <div className="space-y-24 relative">
            <header className="flex justify-around items-center py-4 max-w-screen-2xl mx-auto">
                ...
                <div className="flex items-center sm:divide-x divide-gray-300">
                    ...
                    <div>
                        <div className="pl-4">
                            <button className="text-blue-700 font-semibold rounded-full border border-blue-700 px-5 py-1.5 transition-all flex justify-between gap-4 items-center hover:bg-gray-900 hover:text-white shadow-md">
                                <Image width={16} height={16} src="/LinkedIn_Clone_Google_Logo.png" className="w-4 h-4" alt="image" />
                                Sign in with Google
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="max-w-md w-full">
                        <form>
                            ...
                            <div className="flex flex-col space-y-4 w-full items-center mt-8">
                                <button className="flex items-center justify-center px-6 py-3 border border-gray-300 rounded-full shadow-sm text-md font-medium text-gray-700 hover:bg-gray-50 w-full">
